// Clase ejecutora del programa CALCULA LA PRODUCCION DE 15 OBREROS
...
public class EjecutaObrero2
{
   public static void main(String args[])
   {
     ...
     // Variables
        ...
        int obrero, dia, proDia, totProdObr, totProd, totObreros, mayorProd, menorProd;
        float totSueldos;
