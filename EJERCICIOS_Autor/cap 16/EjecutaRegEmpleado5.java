// Programa CLASIFICA ARCHIVO DE EMPLEADOS POR DEPTO. Y NOMBRE
// Elaborado por: Leobardo López Román
// Esta formado por dos clases: RegEmpleado5 y EjecutaRegEmpleado5
// EjecutaRegEmpleado5.java

import java.util.Scanner;
import java.io.*;
public class EjecutaRegEmpleado5
{
   ...
   {
       String deptosNombres[] = new String[100]; 
    ...
    // Lee los datos del primer empleado del archivo         
       ...
       {
          i = i + 1;
          deptosNombres[i] = objEmpleado.obtenerDepto() + objEmpleado.obtenerNombreEmp();
       ...
       do
       {
          ...
          for (c=1; c<=i; c++)
          {
	      if (deptosNombres[c-1].compareToIgnoreCase(deptosNombres[c]) > 0)
	      {
	         auxiliar = deptosNombres[c];
	         auxiliar2 = direcciones[c];
	         deptosNombres[c] = deptosNombres[c-1];
	         direcciones[c] = direcciones[c-1];
	         deptosNombres[c-1] = auxiliar;
