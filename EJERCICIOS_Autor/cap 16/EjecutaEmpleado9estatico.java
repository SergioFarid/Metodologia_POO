...
// EjecutaEmpleado9estatico.java

import java.util.Scanner;

public class EjecutaEmpleado9estatico
{
   public static void main(String args[])
   {
    ...
    // Crear objeto para entrada de datos por el teclado
       ...
       System.out.println("------------------------------------------");
       Empleado9static.iniciarTotEmpleados();
       Empleado9static.iniciarTotSueldos();
       do
       {
        ...
        // Incrementar
           Empleado9static.incrementarTotEmpleados();
           Empleado9static.incrementarTotSueldos(objEmpleado.obtenerSueldo());
       ...
       System.out.println("\nTotal empleados = " + Empleado9static.obtenerTotEmpleados());
       System.out.println("Total sueldos = " + Empleado9static.obtenerTotSueldos());
   }
}
